...
<section class="main">
     <form class="form-2" method="POST" action="result2.php" align="center">
       ...
       <p>
       <br><br>
        <strong style="color: white; font-size: 25px; text-decoration: underline;">STUDENT ID</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="NUMBER" min="100" max="200" name="student_id" placeholder="STUDENT ID">
        </p>
       
       <br><br><br>
        <p>
            <input type="submit" style="text-align: center;" name="submit" value="submit">
